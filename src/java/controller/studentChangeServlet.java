...
public class studentChangeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (d > maxDays) {
            ...
            request.getRequestDispatcher("studentChange.jsp").forward(request, response);
        }
        else{
            ...
            Students x = (Students) studentSession.getAttribute("student");
            ...
            if(xx != null){
                ...
                response.sendRedirect("studentInfor.jsp");
            }
        }
    }
}
