...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p class="info"><span>Student ID:</span> <%= ID %></p>
            <p class="info"><span>Student Name:</span> <%= name %></p>
            ...
            <p class="info"><span>Department:</span> <%= department %></p>

            <div class="actions">
                <a href="student.jsp">Turn Back</a>
                <a href="studentChange.jsp" class="change">Change Information</a>
            </div>
        </div>
    </body>
</html>
