    ...
    <body>
        ...
        <div class="register-container">
            ...
            <form action="registerStaff" method="post">
                ...
                <select id="position-option" name="position">
                    <option value="Assignment Manager">Assignment Manager</option>
                    <option value="Service Manager">Service Manager</option>
                    <option value="Dorm Guard">Dorm Guard</option>
                    <option value="Dorm Cleaner">Dorm Cleaner</option>
                    <option value="Dorm Technician">Dorm Technician</option>
                </select>
